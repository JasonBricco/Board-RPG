...
public sealed class SetLineFunc : Function 
{
	public SetLineFunc(FunctionLibrary library) : base(library)
	{
	}
	...
	public override void Compute(string[] args, Entity entity)
	{
		if (args.Length != 6) 
		{
			ErrorHandler.LogText("Command Error: invalid argument count for SetLine.", "Usage: SetLine(startX, startY, endX, endY, tile)");
			return;
		}
