...
public sealed class SetSquareFunc : Function 
{
	public SetSquareFunc(FunctionLibrary library) : base(library)
	{
	}
	...
	public override void Compute(string[] args, Entity entity)
	{
		if (args.Length != 6)
		{
			ErrorHandler.LogText("Command Error: invalid argument count for SetSquare.", "Usage: SetSquare(startX, startY, endX, endY, tile)");
			return;
		}
